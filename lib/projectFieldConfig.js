...
// mirrors the order you'd actually think through a project.
//
...
const PLANNED_FIELDS = [...IDEA_FIELDS, 'description', 'vision', 'technicalSpecs', 'roadmap'];
const ACTIVE_FIELDS = [...PLANNED_FIELDS, 'components', 'location', 'research', 'insights'];
...
// all-or-nothing widgets (traits, technicalSpecs, roadmap, components) and
