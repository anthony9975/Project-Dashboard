...
const IDEA_FIELDS = ['title', 'note'];
const PLANNED_FIELDS = [...IDEA_FIELDS, 'category', 'description', 'vision', 'roadmap'];
const ACTIVE_FIELDS = [...PLANNED_FIELDS, 'components', 'location', 'todos', 'research'];
...
export const FIELD_GROUPS = {
  ...
  completed: [...ACTIVE_FIELDS, 'timeline', 'insights', 'nextSteps'],
};
